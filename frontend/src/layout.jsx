...
const Layout = () => {
  ...
  return (
    <>
      ...
      <main className=" mx-auto min-h-screen xl:max-w-screen-lg 2xl:max-w-screen-xl px-6 py-12 md:px-20 md:py-16 lg:py-0">
        <div className="mx-auto flex items-start flex-col lg:flex-row">
          {/* ================= LEFT (DESKTOP SIDEBAR) ================= */}
          <aside className="w-full space-y-8 lg:w-[48%] lg:sticky lg:top-16 lg:h-fit">
            {/* Identity */}
            <div>
              <a href="/" className="flex items-center gap-3 text-4xl sm:text-5xl font-bold tracking-tight text-slate-100 transition-colors duration-300">
              ...
              <span className="mt-3 block text-lg text-left font-normal lg:font-semibold text-slate-200">
            ...
            <nav className="hidden lg:block space-y-4">
              {sections.map((section) => {
                ...
                return (
                  ...
                  >
                    <a className="flex items-center gap-3 text-sm uppercase tracking-widest transition-colors duration-300 hover:text-slate-200">
          ...
          {/* ================= RIGHT (CONTENT) ================= */}
          <section className="flex-1 text-slate-400 lg:w-[52%] mt-20 mb-12 lg:mt-16 text-sm sm:text-base leading-snug sm:leading-relaxed">
            <div className="space-y-36">
              {/* ABOUT */}
              <section id="about">
                <div className="sticky top-0 self-start z-30 bg-slate-900/80 backdrop-blur-md border-b border-white/5 px-4 py-3 mb-10 lg:hidden">
                  <h2
      ...
      ${activeSection === "about" ? "text-teal-300" : "text-slate-400"}`}
                ...
                <p>
                  I’m a software developer with industry experience building reliable, user-focused digital products. My work centers on developing responsive web applications with
                  a strong emphasis on performance, accessibility, and clean architecture.
                </p>
                <p className="mt-4">
              ...
              <section id="experience">
                ...
                <div className="sticky top-0 z-30 bg-slate-900/80 backdrop-blur-md border-b border-white/5 px-4 py-3 mb-10 lg:hidden">
                  <h2
